            ...
            <div class="flex items-start justify-between gap-5">
                <div class="bg-white px-12 pt-5 pb-6 rounded-3xl border shadow-xl w-full">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="font-bold text-xl">Form Input Schedule Travel</div>
                    </div>
                                ...
                                <div class="grid grid-cols-3 gap-5">
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <select
                                            ...
                                            <option value="">Pilih...</option>
                                            @foreach ($route as $m)
                                                <option value="{{ $m->codeRoute }}">{{ $m->route }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <select
                                            class="js-example-placeholder-single js-states form-control w-full m-6 border border-gray-300 rounded-3xl px-4"
                                            id="codeDetailTransportation" name="codeDetailTransportation" data-placeholder="Transportasi">
                                            <option value="">Pilih...</option>
                                            @foreach ($transportation as $d)
                                                <option value="{{ $d->codeDetailTransportation }}">{{ $d->model }}</option>
                                            @endforeach
                                        </select>
                                        <p id="error-codeDetailTransportation" class="mt-2 text-sm text-red-500 hidden">Transportasi wajib
                                            diisi.</p>
                                    </div>
                                </div>
                            </div>
