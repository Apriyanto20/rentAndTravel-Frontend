        ...
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
            <div class="flex items-start justify-between gap-5">
                <div class="bg-white px-12 pt-5 pb-6 rounded-3xl border shadow-xl w-full">
                    ...
                    <div>
                        <form action="{{ route('transportationsTravel.store') }}" method="post"
                            ...
                            <div class="border border-gray-100 px-6 pt-4 rounded-3xl mb-4">
                                ...
                                <div class="grid grid-cols-4 gap-5">
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <p id="error-driverCode" class="mt-2 text-sm text-red-500 hidden">Driver wajib
                                            diisi.</p>
                                    </div>
                                </div>
                            </div>
