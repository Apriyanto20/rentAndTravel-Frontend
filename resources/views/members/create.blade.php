<x-app-layout>
        ...
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
            <div class="flex items-start justify-between gap-5">
                <div class="bg-white px-12 pt-5 pb-6 rounded-3xl border shadow-xl w-full">
                    ...
                    <div>
                        <form action="{{ route('members.store') }}" method="post" id="membersForm" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-5">
                                ...
                                <textarea type="text" name="address" id="address" class="w-full border border-gray-300 rounded-3xl px-4"
                                    placeholder="Alamat ....." oninput="this.value = this.value.toUpperCase();"></textarea>
    ...
    <script>
        ...
        form.addEventListener('submit', function(e) {
            ...
            if (photo.value === '') {
                errorPhoto.classList.remove('hidden');
                isValid = false;
            } else {
                errorPhoto.classList.add('hidden');
            }

            const photoKtp = document.getElementById('photoKtp');
            const errorPhotoKtp = document.getElementById('error-photoKtp');
            if (photoKtp.value === '') {
                errorPhotoKtp.classList.remove('hidden');
                isValid = false;
            } else {
                errorPhotoKtp.classList.add('hidden');
            }
